...
(defun efs/set-font-faces ()
  (message "Setting faces!")
    ...
    (set-face-attribute 'default nil :font "mononoki" :height 111 :weight 'regular)
    ;; Set the fixed pitch face
    (set-face-attribute 'fixed-pitch nil :font "mononoki" :height 111 :weight 'regular)
    ;; Set the variable pitch face
    (set-face-attribute 'variable-pitch nil :font "mononoki" :height 111 :weight 'regular)
)
(if (daemonp)
